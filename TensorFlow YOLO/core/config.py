...
# Set the class name
__C.YOLO.CLASSES                = "./data/classes/flowers.names"
...
__C.TRAIN.ANNOT_PATH            = "./flowerSet/train/Train_anno.txt"
...
__C.TEST.ANNOT_PATH             = "./flowerSet/test/Test_anno.txt"
...
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=8.4694.ckpt-19"
